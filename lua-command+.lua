...
CheatCommands.Text = {
    main = "" ..
        CheatCommands.Config.color1 ..
            CheatCommands.Config.prefix .. CheatCommands.Config.spacer .. CheatCommands.Config.color3 .. "",
...
function CheatCommands.duplicate(informations)
    if (informations.type) then
        ...
        local getData =
            WorldDBQuery("SELECT entry FROM " .. informations.type .. " WHERE entry = " .. informations.digits .. ";")
        if (getData) then
            WorldDBQuery(
                "CREATE TEMPORARY TABLE TEMP_QUERY ENGINE=MEMORY SELECT * FROM " ..
                    informations.type .. " WHERE entry = " .. informations.digits .. ";"
            )
            ...
            informations.result =
                CheatCommands.Config.color5 ..
                WorldDBQuery("SELECT MAX(entry) FROM " .. informations.type .. ";"):GetUInt32(0)
        else
            informations.result = CheatCommands.Text.mainError
        end
    else
...
function CheatCommands.getModel(informations)
    if (informations.type) then
        ...
        local getModel =
            WorldDBQuery(
            "SELECT " ..
                informations.column .. " FROM " .. informations.type .. " where entry=" .. informations.digits .. ";"
        )
...
CheatCommands.Action = {
    [1] = function(player, target)
        player:SendBroadcastMessage(
            CheatCommands.Text.main .. CheatCommands.Text.imodel .. CheatCommands.getModel(CheatCommands.informations)
        )
    end,
    [2] = function(player, target)
        player:SendBroadcastMessage(
            CheatCommands.Text.main .. CheatCommands.Text.cmodel .. CheatCommands.getModel(CheatCommands.informations)
        )
    end,
    [3] = function(player, target)
        player:SendBroadcastMessage(
            CheatCommands.Text.main .. CheatCommands.Text.gmodel .. CheatCommands.getModel(CheatCommands.informations)
        )
    end,
    [4] = function(player, target)
        player:SendBroadcastMessage(
            CheatCommands.Text.main ..
                CheatCommands.Text.centry .. CheatCommands.getSelectEntry(CheatCommands.informations)
        )
    end,
    [5] = function(player, target)
        player:SendBroadcastMessage(
            CheatCommands.Text.main ..
                CheatCommands.Text.cguid .. CheatCommands.getSelectGuid(CheatCommands.informations)
        )
    end,
    [6] = function(player, target)
        player:SendBroadcastMessage(
            CheatCommands.Text.main ..
                CheatCommands.Text.cmodel .. CheatCommands.getSelectModel(CheatCommands.informations)
        )
    end,
    [7] = function(player, target)
        player:SendBroadcastMessage(
            CheatCommands.Text.main .. CheatCommands.Text.idupli .. CheatCommands.duplicate(CheatCommands.informations)
        )
    end,
    [8] = function(player, target)
        player:SendBroadcastMessage(
            CheatCommands.Text.main .. CheatCommands.Text.cdupli .. CheatCommands.duplicate(CheatCommands.informations)
        )
    end,
    [9] = function(player, target)
        player:SendBroadcastMessage(
            CheatCommands.Text.main .. CheatCommands.Text.gdupli .. CheatCommands.duplicate(CheatCommands.informations)
        )
    end,
    [10] = function(player, target)
        player:SendBroadcastMessage(
            CheatCommands.Text.main ..
                CheatCommands.Text.pfaction .. CheatCommands.playerfaction(CheatCommands.informations)
        )
    end,
    [11] = function(player, target)
        player:SendBroadcastMessage(
            CheatCommands.Text.main ..
                CheatCommands.Text.ptele .. CheatCommands.playerteleport(CheatCommands.informations)
        )
    end
}
